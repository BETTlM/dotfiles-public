...
**IMPORTANT**: Never create skills in `~/.cursor/[REDACTED]/`. This directory is reserved for Cursor's internal built-in skills and is managed automatically by the system.
